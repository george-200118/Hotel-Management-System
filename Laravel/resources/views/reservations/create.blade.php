                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 ">
                            ...
                            <a href={{route('reservations.index')}} class="float-right btn-primary btn-sm">Show Reservations</a>
                            </h6>
                        </div>
                            ...
                            <div class="table-responsive">
                                <form method="post" action={{route('reservations.store')}}>
                                    ...
                                    <tr>
                                        ...
                                        <p class="text-danger">{{session('Error_Name')}}</p>
                                        @endif  
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Room Number</th>
                                        <td>
                                            <input type="text" class="form-control col-md-2 mb-3" name="number" >
                                            @error('number')
                                            <p class="text-danger">
                                                {{$message}}
                                            </p>
                                ...
                                @if (Session::has('Error_Room'))
                                <p class="text-danger">{{session('Error_Room')}}</p>
                                @endif
...
<body>
    ...
    <div class="reservation">
            ...
            <form  method="post" action={{route('reservations.store')}} class="needs-validation" >
                @csrf
                <div class="form-row">
