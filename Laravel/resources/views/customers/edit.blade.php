                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 ">
                            <h6 class="m-0 font-weight-bold text-primary"> Edit Customer {{$edit->Name}} </h6>
                        </div>
                        
                        <div class="card-body">
                            <div class="table-responsive">
                                <form method="post" action={{route('customers.update',$edit->Customer_Id)}}>
                                    @csrf
                                    @method('PUT')
...
<body>
    <section class="main">
        ...
        <div class="customer">
            <div class="title">
                <p>Edit Customer {{$edit->Name}}</p>
            </div>
            <form  method="post" action={{route('customers.update',$edit->Customer_Id)}} class="needs-validation" >
                @csrf
                @method('PUT')
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="validationCustom01">Name</label>
                        <input type="text" class="form-control" id="validationCustom01" name="name" value={{$edit->Name}}>
                        @error('name')
                            <p class="text-danger">
                                {{$message}}
                            </p>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom02" name="phone" value={{$edit->Phone}} >
                        @error('phone')
                            <p class="text-danger">
                                {{$message}}
                            </p>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom03" name="address" value={{$edit->Address}} >
                        @error('address')
                            <p class="text-danger">
                                {{$message}}
                            </p>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom04" name="email" value={{$edit->Email}} >
                        @error('email')
                            <p class="text-danger">
                                {{$message}}
                            </p>
