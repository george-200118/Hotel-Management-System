                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 ">
                            <h6 class="m-0 font-weight-bold text-primary"> Edit Room {{$edit->Room_Number}} </h6>
                        </div>
                        
                        <div class="card-body">
                            <div class="table-responsive">
                                <form method="post" action={{route('rooms.update',$edit->Room_Number)}}>
                                    @csrf
                                    @method('PUT')
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <tr>
                                            <th>Room Type</th>
                                            <td>
                                                <select name="type" class="form-control col-md-2 mb-3">
                                                    @if ($edit->Room_Type=='Sweet')
                                                    <option value="Single">Single</option>
                                                    <option value="Double">Double</option>
                                                    <option selected value="Sweet">Sweet</option>  
                                                    @else 
                                                    @if ($edit->Room_Type=='Double')
                                                    <option value="Single">Single</option>
                                                    <option selected value="Double">Double</option>
                                                    <option  value="Sweet">Sweet</option> 
                                                    @else 
                                                    @if ($edit->Room_Type=='Single') 
                                        ...
                                        <tr>
                                            <th>Information</th>
                                            <td>
                                                <textarea class="form-control" name="information">{{$edit->Information}}</textarea>
                                                @error('information')
                                                <p class="text-danger">
                                                    {{$message}}
                                                </p>
                                        ...
                                        <tr>
                                            <th>Status</th>
                                            <td>
                                                <input type="text" disabled class="form-control" id="validationCustom03" name="status" value={{$edit->Status}} >
                                            </td>
                                        </tr>
                                    </table>
...
<body>
    <section class="main">
        ...
        <div class="room">
            <div class="title">
                <p>Edit Room {{$edit->Room_Number}}</p>
            </div>
            <form  method="post" action={{route('rooms.update',$edit->Room_Number)}} class="needs-validation" >
                @csrf
                @method('PUT')
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="validationCustom02">Price</label>
                        <input type="text" class="form-control" id="validationCustom02" name="price" value={{$edit->Price}} >
                        @error('price')
                            <p class="text-danger">
                                {{$message}}
                            </p>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="validationCustom04">Information</label>
                        <textarea class="form-control" name="information" id="validationCustom04">{{$edit->Information}}</textarea>
                        @error('information')
                            <p class="text-danger">
                                {{$message}}
                            </p>
