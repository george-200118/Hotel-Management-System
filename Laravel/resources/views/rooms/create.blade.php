                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 ">
                            ...
                            <a href={{route('rooms.index')}} class="float-right btn-primary btn-sm">Show Rooms</a>
                            </h6>
                        </div>
...
<body>
    <section class="main">
        ...
        <div class="room">
            ...
            <form  method="post" action={{route('rooms.store')}} class="needs-validation" >
                @csrf
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="validationCustom03">Information</label>
                        <textarea class="form-control" name="information" id="validationCustom03"></textarea>
                        @error('information')
                            <p class="text-danger">
                                {{$message}}
                            </p> 
